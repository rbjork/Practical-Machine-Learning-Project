...
# In sample Accuracy 54.3% or 45.6% error
```
...
Out of sample accuracy of 54.1 percent or 45.9%error
...
confusionMatrix(predictions,crossData$classe)
```
In sample Accuracy of 43% 5 deep or 57% error
In sample Accuracy of 42% 5 deep or 58% error
